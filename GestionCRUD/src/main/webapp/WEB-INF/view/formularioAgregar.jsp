...
<link rel="stylesheet"
	...
	<script
	src="${pageContext.request.contextPath}/recursos/js/miScript.js"></script>
...
<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
	...
	<main class="flex-shrink-0 my-5 py-3">
		...
		<div class="container my-5 ">
			<h3 >
			Guardar <small class="text-body-secondary">Cliente</small>
		</h3>



			<form:form id="miForm" action="insertarCliente" modelAttribute="cliente" method="POST">
				
				<form:hidden path="id"/> 
				<div class="container-fluid">
					<div class="row g-3">
						<div class="col-md-4">
							<label id="lname" for="name" class="form-label">Nombre</label>
					...
					<div class="container-fluid mt-2">
						<button id="btnGuardar" type="submit" class="btn btn-outline-success" >
	...
	<footer class="footer mt-auto py-3 bg-body-tertiary">
		...
		<div class="container">
				...
				<p class="text-center text-body-secondary">&copy; 2024 NICOS Company,
					Inc</p>

...
<body class="d-flex flex-column h-100">
						...
						<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
							...
							<li class="nav-item dropdown"><a
								...
								<ul class="dropdown-menu">
									<li><a class="dropdown-item" href="formularioAgregar">Guardar</a></li>
									<li><a class="dropdown-item" href="lista">Ver Todos</a></li>
									<li>
	...
	<script
		src="${pageContext.request.contextPath}/recursos/estilos/bootstrap/js/datatables-latest2.js"></script>
	...
	<script
		src="${pageContext.request.contextPath}/recursos/estilos/bootstrap/js/datatables-simple-demo.js"></script>
